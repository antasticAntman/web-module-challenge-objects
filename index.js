...
console.log(createMenuItem('eggs', 5), 'bekfast');
console.log(createMenuItem('Burger', 11, 'dinner'));
...
Use the addReview function below to do the following:
  1. Receive an array in the FIRST parameter (invoke with the reviews array above)X
  2. Receive the following parameters: name, rating, and feedback; use them in the SECOND, THIRD, and FOURTH parameters (respectively)X
